...
{
    public record GetCollectionByIdQuery(Guid Id, CollectionExpand Expand = CollectionExpand.None, Guid? RequestingUserId = null)
        ...
        : IRequestHandler<GetCollectionByIdQuery, CollectionResponse?>
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (collection.Type != CollectionType.Shared && collection.UserId != request.RequestingUserId)
                return null;
