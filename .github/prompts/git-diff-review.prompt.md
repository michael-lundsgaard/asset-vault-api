...
description: Review a git diff and provide targeted feedback on the changes introduced.
argument-hint: "Analyze the git diff and provide feedback on what's done well and what needs improvement."
---

Analyze the current codebase implementation and provide a structured code review.

Before starting, orient yourself by exploring the project structure.
